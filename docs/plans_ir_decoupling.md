...
- **파일** `docs/data/member_target_filters.json`, `db_swap_preflight.py`, `graph_rag.py`, `tests/test_db_swap_preflight.py`, `tests/test_portability_guard_presence.py`, `docs/operations/db_portability_audit.md`
...
- **파일** `event_compiler.py`, `condition_evaluation_ir.py`, `graph_rag.py`, `join_paths.py`, `docs/data/member_target_filters.json`, `docs/data/capabilities/same_product_co_purchase.json`, `docs/data/event_semantic_registry.json`, `docs/data/dimension_value_index.json`, `docs/data/physical_binding_baseline.json`
