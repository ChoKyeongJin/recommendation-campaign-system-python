...
from .campaign_plan_v4 import CampaignQueryPlanV4
...
class QueryPlannerInput:
    query: str
    query_plan: CampaignQueryPlanV4 | None = None
...
def call_query_planner(
    ...
    **options: Any,
    ...
    if input.query_plan is not None:
        return create_plan(input.query, query_plan_v4=input.query_plan, **options)
