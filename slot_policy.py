...
_CODE_FALLBACK: dict[str, dict[str, Any]] = {
    ...
    "target_user.age_exclude_ranges": {"owner": RULE, "risk": MEDIUM},
    ...
    "target_user.price_sensitivity": {"owner": RULE, "risk": MEDIUM},
    "exclude.gender": {"owner": RULE, "risk": MEDIUM},
    "exclude.interests": {"owner": RULE, "risk": MEDIUM},
    "exclude.lifecycle": {"owner": RULE, "risk": MEDIUM},
    "campaign_constraints.category": {"owner": RULE, "risk": MEDIUM},
